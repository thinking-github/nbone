...
public class MD5Util {
    ...
    public static void main(String args[]) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        String str = "novell";
        String md5 = MD5Util.getEncryptedPwd(str);
        System.out.println(md5);
        System.out.println("MD5后：" + DigestUtils.md5DigestAsHex(str.getBytes()));
        //System.out.println(hexStringToByte(md5));
        System.out.println(MD5Util.validPassword(str, md5));

        String s = new String("frontier");
        System.out.println("原始：" + s);

        System.out.println("MD5后：" + DigestUtils.md5DigestAsHex(s.getBytes()));
        System.out.println("MD5后：" + Hashing.md5().hashString(s, Charset.forName("utf-8")).toString());
