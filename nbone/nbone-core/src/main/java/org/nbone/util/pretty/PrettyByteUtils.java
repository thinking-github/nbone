...
public class PrettyByteUtils {
    ...
    public static void main(String[] args) {
        System.out.println(PrettyByteUtils.prettyByteSize(102600000));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT * UNIT));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT * 1023));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * 1023 * 1023 * 1023));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT * UNIT * UNIT));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT * UNIT * UNIT * UNIT));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT * UNIT * UNIT * UNIT * UNIT));
        System.out.println(PrettyByteUtils.prettyByteSize(1L * UNIT * UNIT * UNIT * UNIT * UNIT * UNIT));
    }
